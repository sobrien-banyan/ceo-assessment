export const reportContentPDF = {
    content_one: `
    <div">
    <p style="margin-bottom:2px;">A fair chance employer is one that considers an applicant’s skills before considering an applicant’s conviction, if
        considered at all. Undoubtedly, including these skilled and valuable employees is good for the community and is good
        for business.</p>
    <p style="font-size:.62rem;font-weight:600;margin-bottom:2px;">Based on the responses you have provided, your fair chance hiring practices are:</p>
    </div>
    `,
    content_two: `
    <br>
    <p style="margin-bottom: 2px;">The Inclusive Hiring team at the Center for Employment Opportunities helps employers catalyze shifts in employment
    ...
    <p style="margin-bottom: 2px;">JPMC is also using their power to do social good by funding legal services for job seekers who are currently
    ...
    <p style="margin-bottom: 2px;">Justine was an experienced executive level manager determined to rehabilitate. After serving seven years for
        ...
        incarceration.</p>
    <p style="margin-bottom: 2px;">Justine quickly secured two part-time jobs and adjusted to being a line-cook with local restaurants. She was
        ...
        apartment.</p>
    <p style="margin-bottom: 2px;">The manager recognized many transferable skills that Justine learned while incarcerated which helped Justine move

...
<template>
    <section v-if="!showResults" class="flex mx-auto lg:items-center lg:justify-between flex-col py-4 bg-tan h-full">
        <div v-if="preamble" class="space-y-12 m-5 wrapper h-full  bg-white border border-gray-200 rounded-lg p-4">
            <h1 class="question font-semibold text-gray-900 ">Please answer the questions to the best of your ability; at the end of the assessment you will be provided a set of recommendations based upon the following four categories: Excellent, Good, Fair, Opportunities to improve.</h1>
            <div class="h-full">
    ...
    <section v-else class="header-container bg-white">
        ...
        <div class="flex top-container px-8 mx-auto items-center justify-between flex-col py-4 relative z-10 h-full">
            <div class="wrapper px-8 flex mx-auto items-center justify-between flex-col h-full">
                <div class="header-text-container">
                    <h1 class="header-text text-center text-5xl text-white header-padding" v-html="responses.header"></h1>
                </div>
                <div class="results-wrapper">
                    <div class="lg:text-xl" v-html="responses.subheader"></div><br>
                        <div class="lg:text-xl" v-html="responses.subheader1"></div><br>

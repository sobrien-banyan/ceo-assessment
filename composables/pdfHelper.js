...
let jsonObject = {
    insertInto: "IH FCH Assessment Report v5",
    insertAfterPage: "1",
    insertData : {
    ...
    for (let key in results) {
        if (key === "2") {
            if (parseInt(results[key]['value']) + parseInt(results[parseInt(key) - 1]['value']) < 4) {
                jsonObject.insertData.results.push({
                    section: results[key]['section'],
                    score: (parseInt(results[key]['value']) + parseInt(results[parseInt(key) - 1]['value'])/16*100).toFixed(0) + "%",
                    feedback: responses.for_1_2.less_than_4,
                    questionsAndAnswers: [
                        {
                ...
                jsonObject.insertData.results.push({
                    section: results[key]['section'],
                    score: (parseInt(results[key]['value']) + parseInt(results[parseInt(key) - 1]['value'])/16*100).toFixed(0) + "%",
                    feedback: responses.for_1_2.equal_to_or_greater_than_4,
                    questionsAndAnswers: [
                        {
                            question: results[key]['question'],
                            answer: results[key]['answer']
        ...
        if (key === "4") {
            if (parseInt(results[key]['value']) + parseInt(results[parseInt(key) - 1]['value']) < 4) {
                jsonObject.insertData.results.push({
                    section: results[key]['section'],
                    score: (parseInt(results[key]['value']) + parseInt(results[parseInt(key) - 1]['value'])/12*100).toFixed(0) + "%",
                    feedback: responses.for_3_4.less_than_4,
                    questionsAndAnswers: [
                        {
                            question: results[key]['question'],
                            answer: results[key]['answer']
                ...
                jsonObject.insertData.results.push({
                    section: results[key]['section'],
                    score: (parseInt(results[key]['value']) + parseInt(results[parseInt(key) - 1]['value'])/12*100).toFixed(0) + "%",
                    feedback: responses.for_3_4.equal_to_or_greater_than_4,
                    questionsAndAnswers: [
                        {
                            question: results[key]['question'],
                            answer: results[key]['answer']
        ...
        if (key === "6") {
            if (parseInt(results[key]['value']) + parseInt(results[parseInt(key) - 1]['value']) < 4) {
                jsonObject.insertData.results.push({
                    section: results[key]['section'],
                    score: (parseInt(results[key]['value']) + parseInt(results[parseInt(key) - 1]['value'])/12*100).toFixed(0) + "%",
                    feedback: responses.for_5_6.less_than_4,
                    questionsAndAnswers: [
                        {
                            question: results[key]['question'],
                            answer: results[key]['answer']
                ...
                jsonObject.insertData.results.push({
                    section: results[key]['section'],
                    score: (parseInt(results[key]['value']) + parseInt(results[parseInt(key) - 1]['value'])/12*100).toFixed(0) + "%",
                    feedback: responses.for_5_6.equal_to_or_greater_than_4,
                    questionsAndAnswers: [
                        {
                            question: results[key]['question'],
                            answer: results[key]['answer']
        ...
        if (key === "8") {
            if (parseInt(results[key]['value']) + parseInt(results[parseInt(key) - 1]['value']) < 4) {
                jsonObject.insertData.results.push({
                    section: results[key]['section'],
                    score: (parseInt(results[key]['value']) + parseInt(results[parseInt(key) - 1]['value'])/12*100).toFixed(0) + "%",
                    feedback: responses.for_7_8.less_than_4,
                    questionsAndAnswers: [
                        {
                            question: results[key]['question'],
                            answer: results[key]['answer']
                ...
                jsonObject.insertData.results.push({
                    section: results[key]['section'],
                    score: (parseInt(results[key]['value']) + parseInt(results[parseInt(key) - 1]['value'])/12*100).toFixed(0) + "%",
                    feedback: responses.for_7_8.equal_to_or_greater_than_4,
                    questionsAndAnswers: [
                        {
                            question: results[key]['question'],
                            answer: results[key]['answer']

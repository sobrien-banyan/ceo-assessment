export const pdfHelper = (grade, results) => {
    let jsonObject = {
    ...
    const responses = {
        ...
        for_3_4: {
            less_than_4: [
                {
                    heading: '',
                    paragraph: `Starting a new job for anyone is difficult and nerve-wracking and it may be exceptionally difficult for those returning to the workforce. People returning from incarceration are adjusting back into society, and are becoming familiar with new norms, customs, and culture. With some support, these individuals will thrive! Furthermore, HR professionals believe the quality of hire of workers with past convictions is the same or better than workers without convictions. Undoubtedly hiring them is good for your place of business! `,
                },
                {
                    heading: 'Human-centered Language',
        ...
        for_5_6: {
            ...
            equal_to_or_greater_than_4: [
                {
                    heading: 'Excellent!',
                    paragraph: `Your workplace understands the importance of talent development for your employees. Employees that experience growth opportunities feel a strong sense of purpose and belonging at work. Way to go!`,
                },
                {
                    heading: '',
                    paragraph: `Now that you have gotten the basics of talent development down, what other creative ways can you set your employees up for success? Take a pulse survey with your current workforce to evaluate what has been meaningful to them and what they believe might be more impactful for them.`
                }
            ]
        },
        for_7_8: {

export const pdfHelper = (overallScore, grade, results) => {
    ...
    const responses = {
        ...
        for_3_4: {
            ...
            equal_to_or_greater_than_4: [
                `You have made significant strides to ensure that your workplace is welcoming! Considerations such as an individualized onboarding plan, and inclusive language signal to your new employees that they matter and are welcome!`,
        ...
        for_5_6: {
            ...
            equal_to_or_greater_than_4: [
                `Your workplace understands the importance of talent development for your employees. Employees that experience growth opportunities feel a strong sense of purpose and belonging at work. Way to go!`,
        ...
        for_7_8: {
            less_than_4: [
                `Critical causes for high employee turnover include poor compensation, insufficient employee benefits, lack of career development opportunities, poor company culture, lack of recognition or rewards, and lack of connectivity with the company.`,
            ...
            equal_to_or_greater_than_4: [
                `Your workplace is a model for other companies seeking to improve their fair chance hiring practices. You have created a culture conducive to growth and development, and your employees want to stick around.`,
